...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<h3 style="text-align: center; color:blue; font-size:35px" >Gestione Corso </h3>
</div>

<% List<Corso> pgsElenco= (List<Corso>) request.getAttribute("elencoCorsi");
   if(pgsElenco.size() > 0){
   		int i = 0;
...
<%while(i< pgsElenco.size()){
	...
	<th> <%= ((Corso)pgsElenco.get(i)).getData_inizio() %></th>
